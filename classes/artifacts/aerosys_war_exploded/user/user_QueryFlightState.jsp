...
<div id="middle">
	...
	<div class="yourSelect">
		...
		<form method="get" action="#"> 
			...
			<%
			if(pageCount>1){%>
				<a href="user_QueryFlightState.jsp?page=<%=pages-1%>">上一页</a>
				<a href="user_QueryFlightState.jsp?page=<%=pages+1%>">下一页</a>
				<a href="user_QueryFlightState.jsp?page=<%=pageCount%>">尾页</a>
